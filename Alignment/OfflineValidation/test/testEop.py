...
process.options = cms.untracked.PSet( SkipEvent = cms.untracked.vstring('ProductNotFound')) ###added 
...
#process.source = cms.Source("PoolSource",
#    fileNames = cms.untracked.vstring(
#        'root://cmsxrootd.fnal.gov//store/relval/CMSSW_10_6_4_patch1/RelValZEE_13/GEN-SIM-RECO/PU25ns_106X_upgrade2018_realistic_v9_HS-v1/10000/03422757-4C01-674A-A263-896DFE62A397.root',
#        'root://cmsxrootd.fnal.gov//store/relval/CMSSW_10_6_4_patch1/RelValZEE_13/GEN-SIM-RECO/PU25ns_106X_upgrade2018_realistic_v9_HS-v1/10000/9C8094F1-4552-F442-9C3D-B2A81EA26A83.root',
#        'root://cmsxrootd.fnal.gov//store/relval/CMSSW_10_6_4_patch1/RelValZEE_13/GEN-SIM-RECO/PU25ns_106X_upgrade2018_realistic_v9_HS-v1/10000/C49CC446-EFD3-EE44-9FEA-EA4EE081DE49.root'
#    )
#)
